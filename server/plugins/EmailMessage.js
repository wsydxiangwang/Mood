...
const Message = ({ type, url, adminInfo }) => {
  const map = {
    'Forgot Password': {
      from: `${adminInfo.base.name} <${adminInfo.administrator.email}>`,
      to: adminInfo.administrator.email,
      subject: `重新设置密码`,
      html: `
          <center>
                      ...
                      <tr>
                          <td>
                              <div style="padding: 30px;color: #303030;border-radius: 8px;box-shadow: 0 0 10px #eee;padding: 1.5rem;">
                                  ...
                                  <p style="text-align: right;margin-top: 40px;font-size:0.9rem">—— ${adminInfo.base.name}</p>
