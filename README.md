...
恭喜你，发现了一个宝藏，在这儿能让你拥有属于自己的网站。

可发帖、做笔记、文章评论、评论通知、订阅通知、文章列表、心情说说、个人介绍等等，完全小白式操作，应有尽有🌞

人民群众称为博客，但我更喜欢把自己的网站称之为：[`心情小镇`](https://raindays.cn)

这是一个入门全栈之路的项目，使用了主流的热门技术，从设计、前端、后端、服务端，一路狂飙的学习，发量正在欣喜若狂~~ 
